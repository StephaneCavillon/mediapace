...
def test_book_creation():
  book = Book.create(title='1984', author='George Orwell', pages=328)
...
def test_book_unicity():
  Book.create(title='1984', author='George Orwell', pages=328, isbn='1234567890')
  with pytest.raises(IntegrityError):
    Book.create(title='1984', author='George Orwell', pages=328, isbn='1234567890')


def test_book_read():
  book = Book.create(title='1984', author='George Orwell', pages=328, isbn='1234567890')
